...
def sanitize_converge_data(filename="cond_pass_basic"+const.fdate):
    """
    Load cond_pass_basic_$(const.fdate);
    ...
    df_san = pd.read_csv(filepath,delimiter="|", converters=convert_dic2)
